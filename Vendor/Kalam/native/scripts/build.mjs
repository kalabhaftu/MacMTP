...
Support for these older versions of macOS is deprecated because maintaining
kernel dylibs for them requires compiling on matching older SDK environments.
